...
[![PyPI](https://img.shields.io/pypi/v/cognis-iocextract.svg)](https://pypi.org/project/cognis-iocextract/)
[![CI](https://github.com/cognis-digital/iocextract/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/iocextract/actions)
...
IOCEXTRACT exists for one job — extract & defang iocs (ips/domains/hashes/urls) from any text — and does it without a SaaS bill or heavyweight setup.
...
```bash
iocextract --version
iocextract scan .                      # scan the current project
iocextract scan . --format json
iocextract scan . --fail-on high       # non-zero exit for CI gates
iocextract mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **iocextract**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`iocextract` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
