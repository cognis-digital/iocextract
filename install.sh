#!/usr/bin/env sh
# Universal installer for iocextract. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/iocextract.git"
echo "Installing iocextract ..."
